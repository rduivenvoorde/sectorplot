...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'sectorplot_location_dialog_base.ui'))

# this determines the Class name base on the FORM_CLASS above
class SectorPlotLocationDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SectorPlotLocationDialog, self).__init__(parent)
